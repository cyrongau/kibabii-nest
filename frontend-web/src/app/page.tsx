...
export default function Home() {
  ...
  const _fetchTestimonials = async () => {
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3000'}/community/testimonials/approved`);
    ...
    <div className="min-h-screen bg-background font-sans scroll-smooth text-foreground transition-colors duration-500">
      ...
      <nav className="flex items-center justify-between px-6 py-6 md:px-20 bg-background/80 backdrop-blur-md sticky top-0 z-50 border-b border-border-subtle">
        ...
        <div className="hidden md:flex gap-10 text-sm font-bold text-muted-foreground">
          ...
          {!user && <a href="/auth/register" className="text-primary hover:opacity-80 transition-opacity">Landlord Onboarding</a>}
          {user && (
            <a 
            ...
            <>
              {!user ? (
                <>
                  ...
                  <a href="/auth/register" className="px-6 py-2.5 text-sm font-bold text-white bg-primary rounded-xl shadow-lg shadow-primary/20 hover:bg-primary/90 hover:scale-[1.02] transition-all">Join as Landlord</a>
                </>
              ) : (
                <div className="flex items-center gap-4">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16 relative z-10">
          <div className="flex-1 space-y-8 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
               ...
               <a 
                 href="/auth/register" 
                 onClick={(e) => handleCtaClick(e, '/auth/register')}
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400 font-bold text-sm">
              <li><a href="/auth/register" className="hover:text-primary transition-colors">List Property</a></li>
